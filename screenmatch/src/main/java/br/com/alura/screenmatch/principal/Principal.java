...
public class Principal {
    ...
    public void exibirMenu(){
        System.out.println("Digite o nome da série para a buscar: ");
...
//                .forEach(System.out::println);
        ...
        System.out.println("Digite o titulo do episodio que está buscando ou um trecho ");
        ...
        episodios.stream()
                ...
                .forEach(e -> System.out.println(
                        "Tempoprada: " + e.getTemporada() +
                                " Episodio: " + e.getTitulo() +
                                " Data de Lançamento: " + e.getDataDeLancamento().format(formatador)
                ));

        //ESTATISTICA FEITA MANUAL
        Map<Integer, Double> avaliacoeTemporada = episodios.stream()
                .filter(e -> e.getAvaliacaoEpisodio() > 0.0)
                .collect(Collectors.groupingBy(Episodio::getTemporada,
                        Collectors.averagingDouble(Episodio::getAvaliacaoEpisodio)));
        System.out.println(avaliacoeTemporada);

        //ESTATISTICAS USANDO O DoubleSummaryStatistics
